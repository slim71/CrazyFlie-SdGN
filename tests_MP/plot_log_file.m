...
figure
subplot(3,1,1), plot(yaw,'r'), title("YAW"); hold on; plot(log_ypr(:,1), 'b'), legend("vicon", "estim");
subplot(3,1,2), plot(pitch,'r'), title("PITCH"); hold on; plot(log_ypr(:,2), 'b');
subplot(3,1,3), plot(roll,'r'), title("ROLL"); hold on; plot(log_ypr(:,3), 'b');

figure
% subplot(2,1,1), plot(pos_sent_toKF(:,1), 'r'), title("X"); hold on; plot(log_xyz(:,1), 'b');
% subplot(2,1,2), 
plot(pos_sent_toKF(:,2), 'r'), title("Y"); hold on; plot(log_xyz(:,2), 'b'), legend("vicon", "estim");

% figure
% plot(pos_sent_toKF(:,3), 'r'), title("Z"); hold on; plot(log_xyz(:,3), 'b');
