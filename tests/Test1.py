...
from myClasses.log_estimation_manager import LogEstimationManager
import time
import logging
...
# DEFINE
from myClasses.vicon_manager import ViconManager
...
# ----------------------------------DEBUG--------------------------------------
# -----------------------------------------------------------------------------
filename = "../PROGETTO/NewLogs/LogFile_CrazyFlie_NOFLAG" \
