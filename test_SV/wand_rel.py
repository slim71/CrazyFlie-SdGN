...
with SyncCrazyflie(sc_v.uri, sc_s.cf) as scf:
    ...
    with PositionHlCommander(
        ...
        while 1:
            ...
            sc_v.Wand_Translation = (sc_v.wand_pos_m[0] -
                                     sc_v.last_wand_pos[0],
                                     sc_v.wand_pos_m[1] -
                                     sc_v.last_wand_pos[1],
                                     sc_v.wand_pos_m[2] -
                                     sc_v.last_wand_pos[2])

            pc.go_to(sc_v.drone_pos[0] + sc_v.Wand_Translation[0]-0.3,
                     sc_v.drone_pos[1] + sc_v.Wand_Translation[1]-0.3,
                     sc_v.drone_pos[2] + sc_v.Wand_Translation[2])
