...
MAX_LOSS = 5                                #Max number of loss during acquisition of the position of the Wand
...
with SyncCrazyflie(uri, cf) as scf:
    ...
    while(1):
        ...
        if(take_off and i<ITERATIONS):
            ...
            #After the take off we send each received position of the wand to the drone
